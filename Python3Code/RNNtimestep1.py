...
train_X = np.reshape(train_X.values, (-1, 1, train_X.shape[1]))  # Reshape to (samples, timesteps, features)
...
test_X = np.reshape(test_X.values, (-1, 1, test_X.shape[1]))  # Reshape to (samples, timesteps, features)
