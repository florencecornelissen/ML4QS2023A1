...
DATASET_FNAME = 'chapter5_result'+participant+'.csv'
RESULT_FNAME = 'chapter7_classification_result'+participant+'.csv'
EXPORT_TREE_PATH = Path('./figures/crowdsignals_ch7_classification'+participant+'/')
